...
const ARTS_CATEGORIES = [
  { id: 'paintings', label: 'Paintings & Artwork', icon: Image, subs: ['Original Paintings', 'Acrylic Paintings', 'Oil Paintings', 'Watercolor Paintings', 'Mixed Media Art', 'Abstract Art', 'Portraits', 'Landscape Art', 'Religious Artwork', 'Contemporary Art', 'Traditional & Cultural Art', 'Digital-Art Prints', 'Art Prints', 'Limited Edition Prints'] },
  { id: 'drawing', label: 'Drawing & Illustration', icon: PenTool, subs: ['Pencil Drawings', 'Charcoal Drawings', 'Ink Drawings', 'Illustrations', 'Sketches', 'Calligraphy Art', 'Hand-Lettered Artwork', 'Drawing Prints'] },
  { id: 'sculptures', label: 'Sculptures & 3D Art', icon: Box, subs: ['Sculptures', 'Statues', 'Figurines', 'Ceramic Sculptures', 'Wood Sculptures', 'Metal Sculptures', 'Stone Sculptures', 'Clay Art', 'Resin Art', 'Decorative 3D Art'] },
  { id: 'handmade', label: 'Handmade Crafts', icon: Scissors, subs: ['Handmade Decorations', 'Handmade Accessories', 'Handmade Bags', 'Handmade Baskets', 'Handmade Home Decor', 'Handmade Toys', 'Handmade Gifts', 'Handmade Ornaments', 'Handmade Cultural Crafts'] },
  { id: 'yarn', label: 'Yarn, Thread & Fiber Crafts', icon: Feather, subs: ['Yarns', 'Threads', 'Embroidery Supplies', 'Crochet Supplies', 'Knitting Supplies', 'Embroidery Hoops', 'Crochet Kits', 'Knitting Kits', 'Finished Crochet Products', 'Finished Knitted Products'] },
  { id: 'supplies', label: 'Craft Supplies', icon: Paperclip, subs: ['Craft Paper', 'Cardstock', 'Foam Sheets', 'Craft Fabric', 'Beads', 'Buttons', 'Ribbons', 'Craft Wire', 'Craft Sticks', 'Craft Tools', 'Craft Adhesives', 'Decorative Materials'] },
  { id: 'beads', label: 'Beads & Jewelry-Making', icon: Gem, subs: ['Beads', 'Gemstone Beads', 'Glass Beads', 'Wooden Beads', 'Jewelry Findings', 'Clasps', 'Chains', 'Jewelry Wire', 'Charms', 'Pendants', 'Jewelry-Making Kits'] },
  { id: 'candles', label: 'Candle & Soap Craft', icon: Flame, subs: ['Candle-Making Supplies', 'Candle Molds', 'Candle Wax', 'Candle Wicks', 'Fragrance Oils', 'Soap-Making Supplies', 'Soap Molds', 'Finished Handmade Candles', 'Handmade Soaps', 'Candle & Soap Gift Sets'] },
  { id: 'woodcraft', label: 'Woodcraft', icon: TreePine, subs: ['Wooden Crafts', 'Carved Wood Art', 'Wooden Decorations', 'Wooden Signs', 'Wooden Figurines', 'Handmade Wooden Furniture', 'Wood Craft Blanks', 'Woodworking Craft Supplies'] },
  { id: 'ceramics', label: 'Ceramics & Pottery', icon: Droplet, subs: ['Handmade Pottery', 'Ceramic Vases', 'Ceramic Plates', 'Ceramic Cups', 'Ceramic Sculptures', 'Clay', 'Pottery Tools', 'Pottery Molds', 'Ceramic Craft Kits'] },
  { id: 'toys', label: 'Handmade Toys & Dolls', icon: Smile, subs: ['Handmade Dolls', 'Plush Toys', 'Cloth Dolls', 'Wooden Toys', 'Handmade Figures', 'Puppet Dolls', 'Doll Accessories', 'Toy-Making Kits'] },
  { id: 'gifts', label: 'Handmade Gifts', icon: Gift, subs: ['Personalized Gifts', 'Handmade Gift Boxes', 'Handmade Cards', 'Handmade Frames', 'Custom Keepsakes', 'Handmade Decorations', 'Gift Sets'] },
  { id: 'cultural', label: 'Cultural & Traditional Crafts', icon: Globe, subs: ['Traditional Artwork', 'Cultural Sculptures', 'Traditional Masks', 'Handmade Baskets', 'Traditional Textiles', 'Cultural Decorations', 'Indigenous Crafts', 'Heritage Collectibles'] },
  { id: 'coins', label: 'Coins & Currency Collectibles', icon: Circle, subs: ['Collectible Coins', 'Commemorative Coins', 'Historical Coins', 'Banknote Collectibles', 'Coin Sets', 'Currency Albums', 'Coin Display Cases', 'Coin Accessories'] },
  { id: 'cards', label: 'Cards & Trading Collectibles', icon: CreditCard, subs: ['Trading Cards', 'Sports Cards', 'Game Cards', 'Collectible Card Sets', 'Card Packs', 'Card Albums', 'Card Sleeves', 'Card Display Cases'] },
  { id: 'figurines', label: 'Figurines & Character Collectibles', icon: User, subs: ['Action Figures', 'Character Figures', 'Anime Figures', 'Movie Collectibles', 'TV Collectibles', 'Comic Collectibles', 'Miniature Figures', 'Collectible Statues'] },
  { id: 'historical', label: 'Historical & Antique Collectibles', icon: Archive, subs: ['Antique Decor', 'Vintage Items', 'Historical Artifacts', 'Vintage Objects', 'Antique Furniture', 'Vintage Advertising Items', 'Historical Memorabilia'] },
  { id: 'sports', label: 'Sports & Event Memorabilia', icon: Trophy, subs: ['Signed Jerseys', 'Signed Balls', 'Sports Cards', 'Trophies', 'Medals', 'Event Memorabilia', 'Team Memorabilia', 'Sports Collectibles'] },
  { id: 'movie', label: 'Movie, Music & Entertainment Collectibles', icon: Film, subs: ['Movie Posters', 'Movie Memorabilia', 'Music Memorabilia', 'Concert Memorabilia', 'Autographed Items', 'Entertainment Figures', 'Collectible Posters'] },
  { id: 'books', label: 'Books, Comics & Printed Collectibles', icon: Book, subs: ['Comic Books', 'Vintage Books', 'Art Books', 'First Editions', 'Collectible Magazines', 'Posters', 'Prints', 'Rare Printed Materials'] },
  { id: 'frames', label: 'Frames & Display', icon: Layout, subs: ['Picture Frames', 'Art Frames', 'Shadow Boxes', 'Display Cases', 'Acrylic Displays', 'Collectible Shelves', 'Wall-Mount Displays', 'Art Hanging Accessories'] },
  { id: 'tools', label: 'Art Tools & Equipment', icon: Brush, subs: ['Paint Brushes', 'Paint Palettes', 'Easels', 'Drawing Boards', 'Sketchbooks', 'Painting Knives', 'Canvases', 'Art Storage', 'Art Tool Sets'] },
  { id: 'kits', label: 'Craft Kits & DIY Sets', icon: Palette, subs: ['Painting Kits', 'Drawing Kits', 'Jewelry-Making Kits', 'Crochet Kits', 'Embroidery Kits', 'Candle-Making Kits', 'Pottery Kits', 'Kids Craft Kits', 'DIY Decoration Kits'] },
  { id: 'gift_sets', label: 'Craft & Collectible Gift Sets', icon: Gift, subs: ['Artist Gift Sets', 'Craft Starter Sets', 'Collector Gift Sets', 'Handmade Gift Sets', 'Art Supply Bundles', 'Collectible Bundles'] },
  { id: 'other', label: 'Other Arts, Crafts & Collectibles', icon: MoreHorizontal, subs: ['Miscellaneous Art Products', 'Miscellaneous Craft Products', 'Miscellaneous Collectibles'] }
]

const COMMON_OPTION_TYPES = ['Size', 'Color', 'Material', 'Condition', 'Medium']
...
export default function ArtsProductBuilder({ productType }: { productType: string | null }) {
  ...
  const activeCategory = ARTS_CATEGORIES.find(c => c.id === category)

  const renderDynamicSpecs = () => {
    const lowerSub = subCategory.toLowerCase()

    if (lowerSub.includes('painting') || lowerSub.includes('drawing') || lowerSub.includes('art print') || lowerSub.includes('illustration')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Dimensions / Size</label><input type="text" value={attributes.Size || ''} onChange={e => handleAttributeChange('Size', e.target.value)} placeholder="e.g. 16x20 inches, A4, 50x70 cm" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Medium / Materials</label><input type="text" value={attributes.Medium || ''} onChange={e => handleAttributeChange('Medium', e.target.value)} placeholder="e.g. Oil on Canvas, Digital Print" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Framed / Unframed</label>
            <select value={attributes.Framed || ''} onChange={e => handleAttributeChange('Framed', e.target.value)} className="w-full border rounded-md px-3 py-2 bg-white">
              <option value="">Select...</option>
              <option value="Framed">Framed</option>
              <option value="Unframed">Unframed</option>
              <option value="Stretched Canvas">Stretched Canvas</option>
              <option value="Rolled in Tube">Rolled in Tube</option>
            </select>
          </div>
          <div><label className="block text-sm font-medium mb-1">Artist / Creator</label><input type="text" value={attributes.Creator || ''} onChange={e => handleAttributeChange('Creator', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
        </div>
      )
    }

    if (lowerSub.includes('collectible') || lowerSub.includes('antique') || lowerSub.includes('vintage') || lowerSub.includes('memorabilia') || lowerSub.includes('card') || lowerSub.includes('coin')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Year / Era</label><input type="text" value={attributes.Year || ''} onChange={e => handleAttributeChange('Year', e.target.value)} placeholder="e.g. 1999, 19th Century, Modern" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Condition</label>
            <select value={attributes.Condition || ''} onChange={e => handleAttributeChange('Condition', e.target.value)} className="w-full border rounded-md px-3 py-2 bg-white">
              ...
              <option value="Graded (Specify below)">Graded (Specify below)</option>
            </select>
          </div>
          <div><label className="block text-sm font-medium mb-1">Certification / Grading (If applicable)</label><input type="text" value={attributes.Certification || ''} onChange={e => handleAttributeChange('Certification', e.target.value)} placeholder="e.g. PSA 9, COA Included" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Brand / Franchise / Maker</label><input type="text" value={attributes.Brand || ''} onChange={e => handleAttributeChange('Brand', e.target.value)} placeholder="e.g. Pokémon, Topps, Rolex" className="w-full border rounded-md px-3 py-2" /></div>
        </div>
      )
    }

    if (lowerSub.includes('craft') || lowerSub.includes('yarn') || lowerSub.includes('bead') || lowerSub.includes('supply') || lowerSub.includes('candle') || lowerSub.includes('soap')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Quantity / Length / Weight</label><input type="text" value={attributes.Quantity || ''} onChange={e => handleAttributeChange('Quantity', e.target.value)} placeholder="e.g. 100g, 50 meters, Pack of 50" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Material / Ingredients</label><input type="text" value={attributes.Material || ''} onChange={e => handleAttributeChange('Material', e.target.value)} placeholder="e.g. 100% Cotton, Soy Wax, Glass" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Color / Scent / Variant</label><input type="text" value={attributes.Color || ''} onChange={e => handleAttributeChange('Color', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Brand (If applicable)</label><input type="text" value={attributes.Brand || ''} onChange={e => handleAttributeChange('Brand', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
        </div>
      )
    }

    if (lowerSub.includes('sculpture') || lowerSub.includes('statue') || lowerSub.includes('figurine') || lowerSub.includes('wood') || lowerSub.includes('ceramic') || lowerSub.includes('pottery')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Dimensions (L x W x H)</label><input type="text" value={attributes.Dimensions || ''} onChange={e => handleAttributeChange('Dimensions', e.target.value)} placeholder="e.g. 10 x 10 x 25 cm" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Material</label><input type="text" value={attributes.Material || ''} onChange={e => handleAttributeChange('Material', e.target.value)} placeholder="e.g. Bronze, Ceramic, Teak Wood" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Weight (Optional)</label><input type="text" value={attributes.Weight || ''} onChange={e => handleAttributeChange('Weight', e.target.value)} placeholder="e.g. 2.5 kg" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Artist / Brand</label><input type="text" value={attributes.Creator || ''} onChange={e => handleAttributeChange('Creator', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
        </div>
      )
    }
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div><label className="block text-sm font-medium mb-1">Creator / Brand</label><input type="text" value={attributes.Brand || ''} onChange={e => handleAttributeChange('Brand', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
  ...
  return (
    <div className="max-w-4xl mx-auto pb-24">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-2xl font-bold tracking-tight">Add Arts, Crafts & Collectibles</h1>
      </div>
