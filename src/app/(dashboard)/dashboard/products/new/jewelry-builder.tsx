...
const JEWELRY_CATEGORIES = [
  { id: 'rings', label: 'Rings', icon: Gem, subs: ['Engagement Rings', 'Wedding Rings', 'Promise Rings', 'Fashion Rings', 'Signet Rings', 'Statement Rings', 'Couple Rings', 'Stackable Rings', 'Birthstone Rings', 'Adjustable Rings', 'Other Rings'] },
  { id: 'necklaces', label: 'Necklaces & Pendants', icon: Star, subs: ['Chain Necklaces', 'Pendant Necklaces', 'Choker Necklaces', 'Statement Necklaces', 'Layered Necklaces', 'Name Necklaces', 'Initial Necklaces', 'Cross Necklaces', 'Pearl Necklaces', 'Couple Necklaces', 'Other Necklaces'] },
  { id: 'earrings', label: 'Earrings', icon: Sparkles, subs: ['Stud Earrings', 'Hoop Earrings', 'Drop Earrings', 'Dangle Earrings', 'Huggie Earrings', 'Ear Cuffs', 'Pearl Earrings', 'Statement Earrings', 'Clip-On Earrings', 'Other Earrings'] },
  { id: 'bracelets', label: 'Bracelets & Bangles', icon: Heart, subs: ['Chain Bracelets', 'Beaded Bracelets', 'Charm Bracelets', 'Cuff Bracelets', 'Tennis Bracelets', 'Bangles', 'Couple Bracelets', 'Friendship Bracelets', 'Adjustable Bracelets', 'Other Bracelets'] },
  { id: 'chains', label: 'Chains', icon: LinkIcon, subs: ['Cuban Chains', 'Rope Chains', 'Box Chains', 'Figaro Chains', 'Snake Chains', 'Curb Chains', 'Link Chains', 'Beaded Chains', 'Layered Chains', 'Other Chains'] },
  { id: 'anklets', label: 'Anklets', icon: Sun, subs: ['Chain Anklets', 'Beaded Anklets', 'Charm Anklets', 'Pearl Anklets', 'Adjustable Anklets', 'Couple Anklets', 'Other Anklets'] },
  { id: 'fine_jewelry', label: 'Fine Jewelry', icon: Gem, subs: ['Gold Jewelry', 'Silver Jewelry', 'Diamond Jewelry', 'Gemstone Jewelry', 'Pearl Jewelry', 'Platinum Jewelry', 'Precious Stone Jewelry', 'Fine Jewelry Sets', 'Other Fine Jewelry'] },
  { id: 'fashion_jewelry', label: 'Fashion Jewelry', icon: Star, subs: ['Fashion Jewelry Sets', 'Costume Jewelry', 'Statement Jewelry', 'Minimalist Jewelry', 'Layered Jewelry', 'Trend Jewelry', 'Body Jewelry', 'Other Fashion Jewelry'] },
  { id: 'charms', label: 'Charms & Pendants', icon: Heart, subs: ['Letter Charms', 'Name Charms', 'Birthstone Charms', 'Symbol Charms', 'Religious Charms', 'Animal Charms', 'Heart Charms', 'Custom Charms', 'Other Charms'] },
  { id: 'hair_acc', label: 'Hair Accessories', icon: Scissors, subs: ['Hair Clips', 'Hair Pins', 'Hair Bows', 'Scrunchies', 'Headbands', 'Hair Bands', 'Claw Clips', 'Hair Combs', 'Decorative Hair Accessories', 'Hair Accessory Sets', 'Other Hair Accessories'] },
  { id: 'eyewear', label: 'Sunglasses & Eyewear', icon: Eye, subs: ['Sunglasses', 'Fashion Glasses', 'Blue-Light Glasses', 'Reading Glasses', 'Eyeglass Frames', 'Cat-Eye Glasses', 'Aviator Glasses', 'Oversized Glasses', 'Kids’ Eyewear', 'Eyewear Cases', 'Other Eyewear'] },
  { id: 'watches', label: 'Watches', icon: Watch, subs: ['Analog Watches', 'Digital Watches', 'Smartwatches', 'Luxury Watches', 'Fashion Watches', 'Sports Watches', 'Couple Watches', 'Kids’ Watches', 'Watch Sets', 'Watch Straps', 'Other Watches'] },
  { id: 'bags', label: 'Bags & Purses', icon: ShoppingBag, subs: ['Handbags', 'Shoulder Bags', 'Crossbody Bags', 'Clutches', 'Mini Bags', 'Tote Bags', 'Waist Bags', 'Evening Bags', 'Coin Purses', 'Wallets', 'Card Holders', 'Other Bags & Purses'] },
  { id: 'wallets', label: 'Wallets & Card Holders', icon: Briefcase, subs: ['Men’s Wallets', 'Women’s Wallets', 'Bi-Fold Wallets', 'Long Wallets', 'Card Holders', 'Coin Wallets', 'Money Clips', 'Passport Wallets', 'Wallet Sets', 'Other Wallets'] },
  { id: 'backpacks', label: 'Backpacks & Small Bags', icon: Package, subs: ['Fashion Backpacks', 'Mini Backpacks', 'Laptop Backpacks', 'Drawstring Bags', 'Travel Pouches', 'Cosmetic Bags', 'Toiletry Bags', 'Organizer Pouches', 'Other Small Bags'] },
  { id: 'ties', label: 'Ties & Formal Accessories', icon: User, subs: ['Neckties', 'Bow Ties', 'Tie Clips', 'Cufflinks', 'Lapel Pins', 'Pocket Squares', 'Tie Sets', 'Formal Accessories Sets', 'Other Formal Accessories'] },
  { id: 'hats', label: 'Hats & Headwear', icon: Umbrella, subs: ['Caps', 'Bucket Hats', 'Fedora Hats', 'Sun Hats', 'Beanies', 'Fascinators', 'Head Wraps', 'Head Scarves', 'Fashion Hats', 'Other Headwear'] },
  { id: 'brooches', label: 'Brooches & Pins', icon: Paperclip, subs: ['Brooches', 'Lapel Pins', 'Enamel Pins', 'Decorative Pins', 'Religious Pins', 'Custom Pins', 'Other Pins'] },
  { id: 'sets', label: 'Jewelry & Accessories Sets', icon: Gift, subs: ['Jewelry Sets', 'Necklace & Earring Sets', 'Bracelet Sets', 'Ring Sets', 'Watch Sets', 'Matching Sets', 'Couple Sets', 'Gift Sets', 'Bridal Jewelry Sets', 'Other Sets'] },
  { id: 'packaging', label: 'Gift & Jewelry Packaging', icon: Box, subs: ['Jewelry Boxes', 'Ring Boxes', 'Bracelet Boxes', 'Necklace Boxes', 'Gift Boxes', 'Jewelry Pouches', 'Jewelry Organizers', 'Travel Jewelry Cases', 'Gift Bags', 'Other Packaging'] },
  { id: 'care', label: 'Jewelry Care & Accessories', icon: Wrench, subs: ['Jewelry Cleaning Cloths', 'Jewelry Cleaning Kits', 'Jewelry Storage Cases', 'Ring Sizers', 'Watch Boxes', 'Watch Straps', 'Jewelry Organizers', 'Other Jewelry Accessories'] },
  { id: 'other', label: 'Other', icon: MoreHorizontal, subs: ['Other Jewelry & Accessories'] }
]

const COMMON_OPTION_TYPES = ['Ring Size', 'Length', 'Material', 'Color', 'Metal', 'Gemstone', 'Watch Dial Size', 'Style']
...
export default function JewelryProductBuilder({ productType }: { productType: string | null }) {
  ...
  const [state, formAction, isPending] = useActionState(createJewelryProductAction, null)
  ...
  const { isRestoring, clearDraft } = useDraftAutoSave('jewelry', draftState, (data) => {
  ...
  const activeCategory = JEWELRY_CATEGORIES.find(c => c.id === category)

  const renderDynamicSpecs = () => {
    const lowerSub = subCategory.toLowerCase()
    
    if (lowerSub.includes('ring') && !lowerSub.includes('box') && !lowerSub.includes('sizer')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Metal Type</label><input type="text" value={attributes.Metal || ''} onChange={e => handleAttributeChange('Metal', e.target.value)} placeholder="e.g. 14k Gold, Sterling Silver, Stainless Steel" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Gemstone (If any)</label><input type="text" value={attributes.Gemstone || ''} onChange={e => handleAttributeChange('Gemstone', e.target.value)} placeholder="e.g. Diamond, Cubic Zirconia, Sapphire" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Ring Size (US)</label><input type="text" value={attributes.Size || ''} onChange={e => handleAttributeChange('Size', e.target.value)} placeholder="e.g. 6, 7, 8 or Adjustable" className="w-full border rounded-md px-3 py-2" /></div>
    ...
    if (lowerSub.includes('necklace') || lowerSub.includes('chain') || lowerSub.includes('pendant') || lowerSub.includes('anklet') || lowerSub.includes('bracelet')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Length (inches or cm)</label><input type="text" value={attributes.Length || ''} onChange={e => handleAttributeChange('Length', e.target.value)} placeholder="e.g. 18 inches, 45cm, Adjustable" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Metal / Material</label><input type="text" value={attributes.Material || ''} onChange={e => handleAttributeChange('Material', e.target.value)} placeholder="e.g. Gold Plated, Silver, Leather" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Clasp Type</label><input type="text" value={attributes.Clasp || ''} onChange={e => handleAttributeChange('Clasp', e.target.value)} placeholder="e.g. Lobster Clasp, Spring Ring" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Brand (Optional)</label><input type="text" value={attributes.Brand || ''} onChange={e => handleAttributeChange('Brand', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
        </div>
      )
    }

    if (lowerSub.includes('watch') && !lowerSub.includes('box')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Movement Type</label>
            <select value={attributes.Movement || ''} onChange={e => handleAttributeChange('Movement', e.target.value)} className="w-full border rounded-md px-3 py-2 bg-white">
          ...
          <div><label className="block text-sm font-medium mb-1">Dial Size (mm)</label><input type="text" value={attributes.DialSize || ''} onChange={e => handleAttributeChange('DialSize', e.target.value)} placeholder="e.g. 40mm, 42mm" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Strap Material</label><input type="text" value={attributes.StrapMaterial || ''} onChange={e => handleAttributeChange('StrapMaterial', e.target.value)} placeholder="e.g. Leather, Stainless Steel, Silicone" className="w-full border rounded-md px-3 py-2" /></div>
    ...
    if (lowerSub.includes('bag') || lowerSub.includes('purse') || lowerSub.includes('wallet') || lowerSub.includes('backpack')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Material</label><input type="text" value={attributes.Material || ''} onChange={e => handleAttributeChange('Material', e.target.value)} placeholder="e.g. Genuine Leather, PU Leather, Canvas" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Dimensions (L x W x H)</label><input type="text" value={attributes.Dimensions || ''} onChange={e => handleAttributeChange('Dimensions', e.target.value)} placeholder="Optional sizing" className="w-full border rounded-md px-3 py-2" /></div>
    ...
    if (lowerSub.includes('glass') || lowerSub.includes('sunglass') || lowerSub.includes('eyewear')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Frame Material</label><input type="text" value={attributes.FrameMaterial || ''} onChange={e => handleAttributeChange('FrameMaterial', e.target.value)} placeholder="e.g. Metal, Acetate, Plastic" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Lens Feature</label><input type="text" value={attributes.LensFeature || ''} onChange={e => handleAttributeChange('LensFeature', e.target.value)} placeholder="e.g. Polarized, UV400, Blue Light Blocking" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Color / Frame Color</label><input type="text" value={attributes.Color || ''} onChange={e => handleAttributeChange('Color', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Brand</label><input type="text" value={attributes.Brand || ''} onChange={e => handleAttributeChange('Brand', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
        </div>
      )
    }
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div><label className="block text-sm font-medium mb-1">Material / Metal</label><input type="text" value={attributes.Material || ''} onChange={e => handleAttributeChange('Material', e.target.value)} placeholder="e.g. Gold Plated, Stainless Steel" className="w-full border rounded-md px-3 py-2" /></div>
        <div><label className="block text-sm font-medium mb-1">Size / Length</label><input type="text" value={attributes.Size || ''} onChange={e => handleAttributeChange('Size', e.target.value)} placeholder="Optional sizing" className="w-full border rounded-md px-3 py-2" /></div>
        <div><label className="block text-sm font-medium mb-1">Color / Finish</label><input type="text" value={attributes.Color || ''} onChange={e => handleAttributeChange('Color', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
        <div><label className="block text-sm font-medium mb-1">Brand (Optional)</label><input type="text" value={attributes.Brand || ''} onChange={e => handleAttributeChange('Brand', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-4xl mx-auto pb-24">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-2xl font-bold tracking-tight">Add Jewelry & Accessories</h1>
      </div>
