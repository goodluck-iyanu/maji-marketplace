...
const AUTOMOTIVE_CATEGORIES = [
  { id: 'engine', label: 'Engine & Mechanical Parts', icon: Wrench, subs: ['Engine Parts', 'Engine Mounts', 'Pistons', 'Piston Rings', 'Gaskets', 'Timing Belts', 'Timing Chains', 'Drive Belts', 'Oil Filters', 'Air Filters', 'Fuel Filters', 'Spark Plugs', 'Glow Plugs', 'Radiators', 'Water Pumps', 'Thermostats', 'Engine Sensors', 'Fuel Pumps', 'Turbochargers', 'Engine Components'] },
  { id: 'transmission', label: 'Transmission & Drivetrain', icon: Settings, subs: ['Transmission Parts', 'Gearbox Parts', 'Clutch Kits', 'Clutch Plates', 'Pressure Plates', 'Flywheels', 'Driveshafts', 'CV Joints', 'Axles', 'Differential Parts', 'Transmission Filters', 'Transmission Mounts'] },
  { id: 'wheels', label: 'Wheels & Tyres', icon: Circle, subs: ['Car Tyres', 'SUV Tyres', 'Truck Tyres', 'Motorcycle Tyres', 'Performance Tyres', 'Off-Road Tyres', 'Alloy Wheels', 'Steel Wheels', 'Wheel Covers', 'Wheel Spacers', 'Tyre Accessories', 'Wheel Accessories'] },
  { id: 'brakes', label: 'Braking System', icon: StopCircle, subs: ['Brake Pads', 'Brake Discs', 'Brake Rotors', 'Brake Calipers', 'Brake Shoes', 'Brake Drums', 'Brake Lines', 'Brake Hoses', 'Brake Fluid', 'Brake Sensors', 'Brake Repair Kits'] },
  { id: 'suspension', label: 'Suspension & Steering', icon: Wrench, subs: ['Shock Absorbers', 'Struts', 'Coil Springs', 'Leaf Springs', 'Control Arms', 'Ball Joints', 'Tie Rod Ends', 'Steering Racks', 'Steering Pumps', 'Stabilizer Links', 'Suspension Bushings', 'Steering Components'] },
  { id: 'lighting', label: 'Automotive Lighting', icon: Lightbulb, subs: ['Headlights', 'Tail Lights', 'Fog Lights', 'LED Bulbs', 'Halogen Bulbs', 'HID Bulbs', 'Indicator Lights', 'Interior Lights', 'Brake Lights', 'Number Plate Lights', 'Light Bars', 'Lighting Accessories'] },
  { id: 'electrical', label: 'Batteries & Electrical', icon: Battery, subs: ['Car Batteries', 'Motorcycle Batteries', 'Battery Chargers', 'Jump Starters', 'Alternators', 'Starters', 'Fuses', 'Relays', 'Wiring Harnesses', 'Car Electrical Components', 'Battery Accessories'] },
  { id: 'cooling', label: 'Cooling & Air Conditioning', icon: Thermometer, subs: ['Radiators', 'Radiator Fans', 'Condensers', 'AC Compressors', 'AC Filters', 'AC Blower Motors', 'Cooling Fans', 'Coolant Reservoirs', 'AC Components', 'Cooling System Accessories'] },
  { id: 'exterior', label: 'Exterior Parts', icon: Car, subs: ['Bumpers', 'Grilles', 'Bonnet/Hood Parts', 'Fenders', 'Doors', 'Door Handles', 'Mirrors', 'Spoilers', 'Mudguards', 'Side Steps', 'Roof Racks', 'Number Plate Frames'] },
  { id: 'interior', label: 'Interior Parts & Accessories', icon: Home, subs: ['Car Seats', 'Seat Covers', 'Floor Mats', 'Dash Mats', 'Steering Wheel Covers', 'Gear Knobs', 'Pedal Covers', 'Sun Shades', 'Headrest Accessories', 'Interior Trim', 'Dashboard Accessories', 'Car Organizers'] },
  { id: 'electronics', label: 'Car Electronics & Infotainment', icon: Smartphone, subs: ['Car Stereos', 'Touchscreen Head Units', 'Android Car Screens', 'Speakers', 'Subwoofers', 'Amplifiers', 'GPS Devices', 'Bluetooth Adapters', 'USB Chargers', 'Car Monitors', 'Remote Controls'] },
  { id: 'security', label: 'Vehicle Security & Tracking', icon: Shield, subs: ['Car Alarms', 'GPS Trackers', 'Immobilizers', 'Central Locking Systems', 'Parking Sensors', 'Dash Cameras', 'Reverse Cameras', 'Vehicle Security Accessories'] },
  { id: 'care', label: 'Car Care & Detailing', icon: Droplet, subs: ['Car Shampoo', 'Car Wax', 'Polish', 'Tire Cleaners', 'Interior Cleaners', 'Glass Cleaners', 'Detailing Brushes', 'Microfiber Cloths', 'Car Vacuum Cleaners', 'Pressure Washers', 'Detailing Kits'] },
  { id: 'fluids', label: 'Oils, Fluids & Lubricants', icon: Droplet, subs: ['Engine Oil', 'Transmission Fluid', 'Brake Fluid', 'Coolant', 'Power Steering Fluid', 'Gear Oil', 'Grease', 'Automotive Lubricants', 'Oil Treatment Products', 'Fluid Accessories'] },
  { id: 'tools', label: 'Automotive Tools', icon: Wrench, subs: ['Socket Sets', 'Spanners', 'Wrenches', 'Screwdrivers', 'Torque Wrenches', 'Jack Stands', 'Car Jacks', 'Diagnostic Scanners', 'Battery Testers', 'Tyre Inflators', 'Air Compressors', 'Workshop Tool Sets'] },
  { id: 'emergency', label: 'Emergency & Roadside Equipment', icon: AlertTriangle, subs: ['Warning Triangles', 'Emergency Kits', 'First Aid Kits', 'Reflective Vests', 'Jump Cables', 'Tow Ropes', 'Tow Straps', 'Tyre Repair Kits', 'Emergency Lights', 'Roadside Tool Kits'] },
  { id: 'travel', label: 'Car Travel & Outdoor Accessories', icon: Tent, subs: ['Roof Boxes', 'Roof Racks', 'Bike Carriers', 'Cargo Organizers', 'Car Fridges', 'Travel Coolers', 'Camping Vehicle Accessories', 'Portable Power Stations', 'Vehicle Tents'] },
  { id: 'motorcycle', label: 'Motorcycle Parts & Accessories', icon: Bike, subs: ['Motorcycle Helmets', 'Motorcycle Gloves', 'Motorcycle Jackets', 'Motorcycle Batteries', 'Motorcycle Lights', 'Motorcycle Mirrors', 'Motorcycle Seats', 'Motorcycle Covers', 'Motorcycle Stands', 'Motorcycle Accessories'] },
  { id: 'truck', label: 'Truck & Commercial Vehicle Parts', icon: Truck, subs: ['Truck Parts', 'Trailer Parts', 'Truck Tyres', 'Trailer Tyres', 'Truck Batteries', 'Truck Lighting', 'Commercial Vehicle Accessories', 'Truck Interior Accessories', 'Trailer Accessories'] },
  { id: 'performance', label: 'Performance & Modification', icon: Activity, subs: ['Performance Exhausts', 'Air Intake Systems', 'Performance Filters', 'Suspension Kits', 'Performance Brakes', 'ECU Accessories', 'Spoilers', 'Body Kits', 'Performance Lighting', 'Racing Accessories'] },
  { id: 'merch', label: 'Automotive Gifts & Merchandise', icon: Gift, subs: ['Automotive Keychains', 'Car-Themed Gifts', 'Car Model Collectibles', 'Automotive Posters', 'Car Accessories Gift Sets'] },
  { id: 'bundles', label: 'Automotive Parts & Accessory Bundles', icon: Package, subs: ['Service Kits', 'Maintenance Kits', 'Brake Kits', 'Clutch Kits', 'Detailing Kits', 'Emergency Kits', 'Car Accessory Bundles'] },
  { id: 'other', label: 'Other Automotive Products', icon: MoreHorizontal, subs: ['Miscellaneous Automotive Parts', 'Miscellaneous Automotive Accessories', 'Other Automotive Products'] }
]

const COMMON_OPTION_TYPES = ['Make/Model Compatibility', 'Year', 'Size', 'Color', 'Material', 'Capacity/Volume']
...
export default function AutomotiveProductBuilder({ productType }: { productType: string | null }) {
  ...
  const [state, formAction, isPending] = useActionState(createAutomotiveProductAction, null)
  ...
  const { isRestoring, clearDraft } = useDraftAutoSave('automotive', draftState, (data) => {
  ...
  const activeCategory = AUTOMOTIVE_CATEGORIES.find(c => c.id === category)

  const renderDynamicSpecs = () => {
    const lowerSub = subCategory.toLowerCase()

    if (lowerSub.includes('part') || lowerSub.includes('engine') || lowerSub.includes('transmission') || lowerSub.includes('brake') || lowerSub.includes('suspension') || lowerSub.includes('steering') || lowerSub.includes('exterior')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Compatible Make & Model</label><input type="text" value={attributes.MakeModel || ''} onChange={e => handleAttributeChange('MakeModel', e.target.value)} placeholder="e.g. Toyota Corolla, Universal, BMW 3 Series" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Compatible Years</label><input type="text" value={attributes.Years || ''} onChange={e => handleAttributeChange('Years', e.target.value)} placeholder="e.g. 2014-2018" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Part Number (OEM / Aftermarket)</label><input type="text" value={attributes.PartNumber || ''} onChange={e => handleAttributeChange('PartNumber', e.target.value)} placeholder="e.g. 12345-ABC" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Brand / Manufacturer</label><input type="text" value={attributes.Brand || ''} onChange={e => handleAttributeChange('Brand', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
        </div>
      )
    }

    if (lowerSub.includes('tyre') || lowerSub.includes('wheel')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Size Specs</label><input type="text" value={attributes.TyreSize || ''} onChange={e => handleAttributeChange('TyreSize', e.target.value)} placeholder="e.g. 205/55 R16, 18 Inch" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Type / Season</label>
            <select value={attributes.Season || ''} onChange={e => handleAttributeChange('Season', e.target.value)} className="w-full border rounded-md px-3 py-2 bg-white">
              <option value="">Select...</option>
              <option value="All-Season">All-Season</option>
              <option value="Summer">Summer</option>
              <option value="Winter">Winter</option>
              <option value="Performance / Sport">Performance / Sport</option>
              <option value="Off-Road / All-Terrain">Off-Road / All-Terrain</option>
            </select>
          </div>
          <div><label className="block text-sm font-medium mb-1">Bolt Pattern (If Wheel)</label><input type="text" value={attributes.BoltPattern || ''} onChange={e => handleAttributeChange('BoltPattern', e.target.value)} placeholder="e.g. 5x114.3" className="w-full border rounded-md px-3 py-2" /></div>
    ...
    if (lowerSub.includes('oil') || lowerSub.includes('fluid') || lowerSub.includes('lubricant') || lowerSub.includes('shampoo') || lowerSub.includes('wax') || lowerSub.includes('cleaner') || lowerSub.includes('polish')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Volume / Capacity</label><input type="text" value={attributes.Volume || ''} onChange={e => handleAttributeChange('Volume', e.target.value)} placeholder="e.g. 1L, 4L, 500ml" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Grade / Specification</label><input type="text" value={attributes.Grade || ''} onChange={e => handleAttributeChange('Grade', e.target.value)} placeholder="e.g. 5W-30, DOT 4, Carnauba" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Compatible Vehicles</label><input type="text" value={attributes.Compatibility || ''} onChange={e => handleAttributeChange('Compatibility', e.target.value)} placeholder="e.g. Petrol, Diesel, Universal" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Brand</label><input type="text" value={attributes.Brand || ''} onChange={e => handleAttributeChange('Brand', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
        </div>
      )
    }

    if (lowerSub.includes('battery') || lowerSub.includes('lighting') || lowerSub.includes('bulb') || lowerSub.includes('electronics') || lowerSub.includes('stereo') || lowerSub.includes('camera')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Specs / Power</label><input type="text" value={attributes.Specs || ''} onChange={e => handleAttributeChange('Specs', e.target.value)} placeholder="e.g. 12V 60Ah, H7 55W, 1080p HD" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Fitment / Model</label><input type="text" value={attributes.Fitment || ''} onChange={e => handleAttributeChange('Fitment', e.target.value)} placeholder="e.g. Universal, DIN/Double DIN, specific model" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Features (Optional)</label><input type="text" value={attributes.Features || ''} onChange={e => handleAttributeChange('Features', e.target.value)} placeholder="e.g. Bluetooth, LED, Night Vision" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Brand</label><input type="text" value={attributes.Brand || ''} onChange={e => handleAttributeChange('Brand', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
        </div>
      )
    }
    
    if (lowerSub.includes('interior') || lowerSub.includes('seat') || lowerSub.includes('mat') || lowerSub.includes('cover')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Material</label><input type="text" value={attributes.Material || ''} onChange={e => handleAttributeChange('Material', e.target.value)} placeholder="e.g. Leather, Fabric, Rubber" className="w-full border rounded-md px-3 py-2" /></div>
          ...
          <div><label className="block text-sm font-medium mb-1">Fitment</label><input type="text" value={attributes.Fitment || ''} onChange={e => handleAttributeChange('Fitment', e.target.value)} placeholder="e.g. Universal Fit, Custom Fit" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Brand</label><input type="text" value={attributes.Brand || ''} onChange={e => handleAttributeChange('Brand', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
        </div>
      )
    }
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div><label className="block text-sm font-medium mb-1">Brand</label><input type="text" value={attributes.Brand || ''} onChange={e => handleAttributeChange('Brand', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
        <div><label className="block text-sm font-medium mb-1">Compatible Make/Model (Optional)</label><input type="text" value={attributes.Compatibility || ''} onChange={e => handleAttributeChange('Compatibility', e.target.value)} placeholder="e.g. Universal" className="w-full border rounded-md px-3 py-2" /></div>
        <div><label className="block text-sm font-medium mb-1">Color / Design</label><input type="text" value={attributes.Color || ''} onChange={e => handleAttributeChange('Color', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
        <div><label className="block text-sm font-medium mb-1">Material / Specs</label><input type="text" value={attributes.Details || ''} onChange={e => handleAttributeChange('Details', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-4xl mx-auto pb-24">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-2xl font-bold tracking-tight">Add Automotive</h1>
      </div>
