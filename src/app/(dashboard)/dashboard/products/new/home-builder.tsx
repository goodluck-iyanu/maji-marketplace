...
const HOME_CATEGORIES = [
  { id: 'sofas', label: 'Sofas & Couches', icon: Box, subs: ['2-Seater Sofa', '3-Seater Sofa', '4-Seater Sofa', 'L-Shaped Sofa', 'Sectional Sofa', 'Sofa Bed', 'Recliner Sofa', 'Loveseat', 'Armchair', 'Lounge Chair', 'Ottoman', 'Pouf', 'Sofa Set', 'Other Sofas & Couches'] },
  { id: 'chairs', label: 'Chairs & Seating', icon: Briefcase, subs: ['Dining Chair', 'Office Chair', 'Executive Chair', 'Gaming Chair', 'Accent Chair', 'Plastic Chair', 'Folding Chair', 'Bar Stool', 'Counter Stool', 'Armchair', 'Reclining Chair', 'Rocking Chair', 'Bench', 'Outdoor Chair', 'Other Chairs'] },
  { id: 'beds', label: 'Beds & Bedroom Furniture', icon: Home, subs: ['Single Bed Frame', 'Double Bed Frame', 'Queen Bed Frame', 'King Bed Frame', 'Bunk Bed', 'Platform Bed', 'Storage Bed', 'Bedside Table', 'Bedroom Bench', 'Dressing Table', 'Vanity Table', 'Bedroom Stool', 'Other Bedroom Furniture'] },
  { id: 'mattresses', label: 'Mattresses & Bedding', icon: Box, subs: ['Single Mattress', 'Double Mattress', 'Queen Mattress', 'King Mattress', 'Memory Foam Mattress', 'Orthopedic Mattress', 'Spring Mattress', 'Foam Mattress', 'Mattress Topper', 'Mattress Protector', 'Pillow', 'Bed Pillow Set', 'Other Bedding'] },
  { id: 'tables', label: 'Tables & Desks', icon: Monitor, subs: ['Dining Table', 'Coffee Table', 'Side Table', 'Console Table', 'Center Table', 'Study Table', 'Office Desk', 'Computer Desk', 'Gaming Desk', 'Bedside Table', 'Dressing Table', 'Folding Table', 'Outdoor Table', 'Other Tables & Desks'] },
  { id: 'storage', label: 'Storage & Organization', icon: Archive, subs: ['Wardrobe', 'Cabinet', 'Drawer Chest', 'Bookshelf', 'Shoe Rack', 'Storage Rack', 'Storage Box', 'Storage Basket', 'TV Stand', 'Display Shelf', 'Wall Shelf', 'Kitchen Storage', 'Bathroom Storage', 'Other Storage'] },
  { id: 'tv_stands', label: 'TV Stands & Entertainment', icon: Tv, subs: ['TV Stand', 'TV Console', 'Entertainment Center', 'Media Cabinet', 'TV Wall Shelf', 'Speaker Stand', 'Game Console Stand', 'Cable Management Box', 'Remote Control Holder', 'Other Entertainment Furniture'] },
  { id: 'mirrors', label: 'Mirrors', icon: Sun, subs: ['Wall Mirror', 'Full-Length Mirror', 'Dressing Mirror', 'Standing Mirror', 'Bathroom Mirror', 'Decorative Mirror', 'LED Mirror', 'Makeup Mirror', 'Other Mirrors'] },
  { id: 'lighting', label: 'Lighting', icon: Zap, subs: ['Table Lamp', 'Desk Lamp', 'Floor Lamp', 'Ceiling Light', 'Pendant Light', 'Wall Light', 'LED Light', 'Night Light', 'Smart Light', 'Decorative Light', 'Rechargeable Lamp', 'Other Lighting'] },
  { id: 'decor', label: 'Home Decor', icon: Sparkles, subs: ['Wall Art', 'Wall Decor', 'Decorative Frames', 'Vases', 'Artificial Flowers', 'Decorative Plants', 'Sculptures', 'Figurines', 'Clocks', 'Candle Holders', 'Decorative Trays', 'Ornaments', 'Home Decor Sets', 'Other Home Decor'] },
  { id: 'curtains', label: 'Curtains & Window Accessories', icon: Layout, subs: ['Curtains', 'Blackout Curtains', 'Sheer Curtains', 'Window Blinds', 'Roller Blinds', 'Curtain Rods', 'Curtain Rails', 'Curtain Rings', 'Curtain Tiebacks', 'Curtain Sets', 'Other Window Accessories'] },
  { id: 'rugs', label: 'Rugs & Carpets', icon: Layers, subs: ['Area Rug', 'Living Room Rug', 'Bedroom Rug', 'Bathroom Mat', 'Kitchen Mat', 'Door Mat', 'Prayer Rug', 'Runner Rug', 'Outdoor Rug', 'Carpet', 'Rug Set', 'Other Rugs & Carpets'] },
  { id: 'bathroom', label: 'Bathroom', icon: Droplet, subs: ['Bathroom Shelves', 'Bathroom Cabinet', 'Shower Curtain', 'Bath Mat', 'Towel Rack', 'Soap Dispenser', 'Toothbrush Holder', 'Toilet Paper Holder', 'Bathroom Organizer', 'Laundry Basket', 'Bathroom Mirror', 'Other Bathroom Products'] },
  { id: 'dining_kitchen', label: 'Dining & Kitchen Furniture', icon: Coffee, subs: ['Dining Table', 'Dining Chair', 'Dining Set', 'Kitchen Stool', 'Kitchen Island', 'Kitchen Cart', 'Bar Stool', 'Kitchen Shelf', 'Kitchen Rack', 'Serving Trolley', 'Other Kitchen Furniture'] },
  { id: 'laundry', label: 'Laundry & Cleaning', icon: Trash2, subs: ['Laundry Basket', 'Laundry Hamper', 'Drying Rack', 'Ironing Board', 'Cleaning Storage', 'Mop Holder', 'Cleaning Organizer', 'Storage Basket', 'Utility Cart', 'Other Laundry & Cleaning Products'] },
  { id: 'outdoor', label: 'Outdoor & Patio Furniture', icon: TreePine, subs: ['Outdoor Chair', 'Outdoor Table', 'Patio Set', 'Garden Chair', 'Garden Table', 'Plastic Table', 'Plastic Chair', 'Balcony Furniture', 'Outdoor Bench', 'Outdoor Storage', 'Other Outdoor Furniture'] },
  { id: 'accessories', label: 'Home Accessories', icon: Gift, subs: ['Cushions', 'Throw Pillows', 'Blankets', 'Throws', 'Table Covers', 'Placemats', 'Coasters', 'Tissue Box Covers', 'Decorative Trays', 'Furniture Covers', 'Other Home Accessories'] },
  { id: 'sets', label: 'Home & Furniture Sets', icon: Package, subs: ['Sofa Set', 'Dining Set', 'Bedroom Set', 'Living Room Set', 'Office Furniture Set', 'Bathroom Set', 'Home Decor Set', 'Kitchen Set', 'Outdoor Furniture Set', 'Other Furniture Bundles'] }
]

const COMMON_OPTION_TYPES = ['Color', 'Material', 'Size', 'Dimensions', 'Wood Type', 'Fabric', 'Style']
...
export default function HomeProductBuilder({ productType }: { productType: string | null }) {
  ...
  const [state, formAction, isPending] = useActionState(createHomeProductAction, null)
  ...
  const { isRestoring, clearDraft } = useDraftAutoSave('home', draftState, (data) => {
  ...
  const activeCategory = HOME_CATEGORIES.find(c => c.id === category)

  const renderDynamicSpecs = () => {
    const lowerSub = subCategory.toLowerCase()
    
    if (lowerSub.includes('sofa') || lowerSub.includes('couch') || lowerSub.includes('reclin') || lowerSub.includes('mattress') || lowerSub.includes('bed ') || lowerSub.includes('bed frame') || lowerSub.includes('wardrobe') || lowerSub.includes('cabinet') || lowerSub.includes('table') || lowerSub.includes('desk')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Dimensions (L x W x H)</label><input type="text" value={attributes.Dimensions || ''} onChange={e => handleAttributeChange('Dimensions', e.target.value)} placeholder="e.g. 200cm x 90cm x 85cm" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Weight / Package Weight</label><input type="text" value={attributes.Weight || ''} onChange={e => handleAttributeChange('Weight', e.target.value)} placeholder="e.g. 45kg" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Main Material</label><input type="text" value={attributes.Material || ''} onChange={e => handleAttributeChange('Material', e.target.value)} placeholder="e.g. Leather, Solid Wood, Velvet" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Color</label><input type="text" value={attributes.Color || ''} onChange={e => handleAttributeChange('Color', e.target.value)} placeholder="e.g. Gray, Brown, White" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Brand / Manufacturer (Optional)</label><input type="text" value={attributes.Brand || ''} onChange={e => handleAttributeChange('Brand', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Requires Assembly?</label>
            <select value={attributes.Assembly || ''} onChange={e => handleAttributeChange('Assembly', e.target.value)} className="w-full border rounded-md px-3 py-2 bg-white">
              <option value="">Select...</option>
              <option value="Yes - Full Assembly">Yes - Full Assembly</option>
              <option value="Yes - Partial Assembly">Yes - Partial Assembly</option>
              <option value="No - Comes Assembled">No - Comes Assembled</option>
            </select>
          </div>
        </div>
      )
    ...
    if (lowerSub.includes('curtain') || lowerSub.includes('blind') || lowerSub.includes('rug') || lowerSub.includes('carpet')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Dimensions / Size</label><input type="text" value={attributes.Dimensions || ''} onChange={e => handleAttributeChange('Dimensions', e.target.value)} placeholder="e.g. 5ft x 8ft or 200cm Drop" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Material / Fabric</label><input type="text" value={attributes.Material || ''} onChange={e => handleAttributeChange('Material', e.target.value)} placeholder="e.g. Cotton, Polyester, Wool" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Color / Pattern</label><input type="text" value={attributes.Color || ''} onChange={e => handleAttributeChange('Color', e.target.value)} placeholder="e.g. Geometric Blue, Solid Beige" className="w-full border rounded-md px-3 py-2" /></div>
    ...
    if (lowerSub.includes('light') || lowerSub.includes('lamp')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Power Source</label>
            <select value={attributes.PowerSource || ''} onChange={e => handleAttributeChange('PowerSource', e.target.value)} className="w-full border rounded-md px-3 py-2 bg-white">
              <option value="">Select...</option>
              <option value="Wired / Plug-in">Wired / Plug-in</option>
              <option value="Hardwired (Ceiling/Wall)">Hardwired (Ceiling/Wall)</option>
              <option value="Battery Operated">Battery Operated</option>
              <option value="Rechargeable">Rechargeable</option>
              <option value="Solar">Solar</option>
            </select>
          </div>
          <div><label className="block text-sm font-medium mb-1">Light Type / Bulb</label><input type="text" value={attributes.BulbType || ''} onChange={e => handleAttributeChange('BulbType', e.target.value)} placeholder="e.g. LED, E27 Bulb" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Material</label><input type="text" value={attributes.Material || ''} onChange={e => handleAttributeChange('Material', e.target.value)} placeholder="e.g. Metal, Glass, Wood" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Color / Finish</label><input type="text" value={attributes.Color || ''} onChange={e => handleAttributeChange('Color', e.target.value)} placeholder="e.g. Matte Black, Brass" className="w-full border rounded-md px-3 py-2" /></div>
        </div>
      )
    }
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div><label className="block text-sm font-medium mb-1">Material</label><input type="text" value={attributes.Material || ''} onChange={e => handleAttributeChange('Material', e.target.value)} placeholder="e.g. Wood, Plastic, Ceramic" className="w-full border rounded-md px-3 py-2" /></div>
        <div><label className="block text-sm font-medium mb-1">Dimensions / Size</label><input type="text" value={attributes.Dimensions || ''} onChange={e => handleAttributeChange('Dimensions', e.target.value)} placeholder="Optional sizing" className="w-full border rounded-md px-3 py-2" /></div>
  ...
  return (
    <div className="max-w-4xl mx-auto pb-24">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-2xl font-bold tracking-tight">Add Home & Furniture Product</h1>
      </div>
