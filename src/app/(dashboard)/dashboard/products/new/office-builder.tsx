...
import { ArrowLeft, Check, Upload, X, Loader2, PlusCircle, Trash2, Pen, Book, Folder, Printer, Droplet, Monitor, Phone, Calculator, Archive, PieChart, Video, Home, Lock, CreditCard, Receipt, Package, Paperclip, Coffee, Shield, Tag, Gift, Store, MoreHorizontal } from 'lucide-react'
import Link from 'next/link'
import { createOfficeProductAction } from '../actions'

const STEPS = [
  { id: 'type', label: 'Office Category' },
...
const OFFICE_CATEGORIES = [
  { id: 'writing', label: 'Writing & Desk Supplies', icon: Pen, subs: ['Ballpoint Pens', 'Gel Pens', 'Fountain Pens', 'Pencils', 'Mechanical Pencils', 'Markers', 'Highlighters', 'Correction Pens & Fluids', 'Erasers', 'Pencil Sharpeners', 'Pen Holders', 'Desk Organizers'] },
  { id: 'notebooks', label: 'Notebooks & Paper Products', icon: Book, subs: ['Notebooks', 'Notepads', 'Journals', 'Writing Pads', 'Memo Pads', 'Sticky Notes', 'Printer Paper', 'Copier Paper', 'Colored Paper', 'Cardstock', 'Letterhead Paper', 'Carbonless Forms'] },
  { id: 'files', label: 'Files & Document Storage', icon: Folder, subs: ['File Folders', 'Ring Binders', 'Lever Arch Files', 'Document Wallets', 'Expanding Files', 'Filing Trays', 'Magazine Holders', 'Document Boxes', 'Archive Boxes', 'File Dividers', 'Document Sleeves'] },
  { id: 'printers', label: 'Printers & Scanners', icon: Printer, subs: ['Inkjet Printers', 'Laser Printers', 'All-in-One Printers', 'Photo Printers', 'Label Printers', 'Receipt Printers', 'Barcode Printers', 'Document Scanners', 'Portable Scanners', 'Printer Accessories'] },
  { id: 'printer_supplies', label: 'Printer Supplies', icon: Droplet, subs: ['Ink Cartridges', 'Toner Cartridges', 'Printer Drums', 'Print Heads', 'Printer Ribbons', 'Label Rolls', 'Thermal Paper', 'Maintenance Kits'] },
  { id: 'electronics', label: 'Office Electronics', icon: Monitor, subs: ['Desktop Computers', 'Laptops', 'Monitors', 'Keyboards', 'Mice', 'Webcams', 'Speakers', 'Headsets', 'USB Hubs', 'Docking Stations', 'External Storage', 'Computer Accessories'] },
  { id: 'communication', label: 'Communication Equipment', icon: Phone, subs: ['Office Phones', 'Desk Phones', 'Intercom Systems', 'Conference Phones', 'Walkie-Talkies', 'Video Conferencing Equipment', 'Communication Accessories'] },
  { id: 'calculators', label: 'Calculators & Business Machines', icon: Calculator, subs: ['Basic Calculators', 'Scientific Calculators', 'Financial Calculators', 'Printing Calculators', 'Cash Registers', 'Counting Machines', 'Label Makers', 'Time Clocks'] },
  { id: 'organization', label: 'Office Organization', icon: Archive, subs: ['Desk Organizers', 'File Trays', 'Letter Trays', 'Pen Holders', 'Cable Organizers', 'Drawer Organizers', 'Storage Bins', 'Desktop Shelves', 'Whiteboard Organizers'] },
  { id: 'presentation', label: 'Presentation & Meeting Supplies', icon: PieChart, subs: ['Whiteboards', 'Notice Boards', 'Flip Charts', 'Flip Chart Pads', 'Presentation Boards', 'Projector Screens', 'Laser Pointers', 'Presentation Remotes', 'Easels', 'Name Tags', 'Conference Supplies'] },
  { id: 'projectors', label: 'Projectors & Presentation Equipment', icon: Video, subs: ['Projectors', 'Portable Projectors', 'Projector Screens', 'Projector Mounts', 'Presentation Remotes', 'Projector Accessories'] },
  { id: 'furniture', label: 'Office Furniture', icon: Home, subs: ['Office Chairs', 'Executive Chairs', 'Reception Chairs', 'Office Desks', 'Executive Desks', 'Reception Desks', 'Conference Tables', 'Filing Cabinets', 'Office Shelves', 'Bookcases', 'Storage Cabinets', 'Office Furniture Sets'] },
  { id: 'security', label: 'Office Security & Access', icon: Lock, subs: ['Safes', 'Key Cabinets', 'Lock Boxes', 'Access Control Devices', 'Security Locks', 'Visitor Management Equipment', 'ID Card Holders', 'Security Accessories'] },
  { id: 'id_supplies', label: 'ID & Identification Supplies', icon: CreditCard, subs: ['ID Card Printers', 'ID Cards', 'ID Card Holders', 'Lanyards', 'Badge Holders', 'Badge Reels', 'Visitor Badges', 'Name Tags'] },
  { id: 'pos', label: 'Point-of-Sale & Retail Supplies', icon: Receipt, subs: ['Receipt Printers', 'Barcode Scanners', 'Barcode Labels', 'POS Stands', 'Cash Drawers', 'Price Tag Guns', 'Receipt Rolls', 'Shopping Bags', 'Retail Display Accessories'] },
  { id: 'packaging', label: 'Packaging & Shipping Supplies', icon: Package, subs: ['Shipping Boxes', 'Mailing Envelopes', 'Bubble Wrap', 'Packing Tape', 'Packaging Labels', 'Shipping Bags', 'Stretch Film', 'Packing Paper', 'Postal Tubes', 'Shipping Accessories'] },
  { id: 'binding', label: 'Office Binding & Finishing', icon: Paperclip, subs: ['Staplers', 'Staples', 'Hole Punchers', 'Paper Cutters', 'Guillotine Cutters', 'Binding Machines', 'Binding Combs', 'Laminating Machines', 'Laminating Pouches', 'Paper Trimmers'] },
  { id: 'cleaning', label: 'Office Cleaning & Maintenance', icon: Trash2, subs: ['Cleaning Supplies', 'Disinfectant Products', 'Waste Bins', 'Waste Bags', 'Paper Towels', 'Tissue Products', 'Air Fresheners', 'Cleaning Tools', 'Office Maintenance Accessories'] },
  { id: 'pantry', label: 'Break Room & Pantry Supplies', icon: Coffee, subs: ['Mugs', 'Cups', 'Plates', 'Cutlery', 'Water Bottles', 'Food Storage Containers', 'Coffee Accessories', 'Tea Accessories', 'Office Kitchen Accessories'] },
  { id: 'safety', label: 'Workplace Safety Supplies', icon: Shield, subs: ['Safety Signs', 'First Aid Kits', 'Fire Extinguishers', 'Safety Gloves', 'Safety Goggles', 'Protective Equipment', 'Emergency Equipment'] },
  { id: 'labels', label: 'Labels, Signs & Printing Materials', icon: Tag, subs: ['Label Sheets', 'Barcode Labels', 'Address Labels', 'Name Labels', 'Signage Materials', 'Sticker Paper', 'Printable Cards', 'Receipt Paper'] },
  { id: 'gifts', label: 'Corporate Gifts & Business Accessories', icon: Gift, subs: ['Corporate Gift Sets', 'Branded Pens', 'Branded Notebooks', 'Business Card Holders', 'Keychains', 'Desk Gifts', 'Executive Gift Sets', 'Promotional Accessories'] },
  { id: 'commercial', label: 'Commercial & Business Equipment', icon: Store, subs: ['Retail Display Equipment', 'Shop Counters', 'Display Stands', 'Shelving', 'Storage Racks', 'Business Scales', 'Commercial Labeling Equipment', 'Commercial Office Equipment'] },
  { id: 'bundles', label: 'Office Supply Bundles', icon: Gift, subs: ['New Office Starter Kits', 'Stationery Bundles', 'Meeting Room Kits', 'Printer Supply Bundles', 'Corporate Gift Bundles', 'School/Office Supply Bundles'] },
  { id: 'other', label: 'Other Office & Business Supplies', icon: MoreHorizontal, subs: ['Miscellaneous Office Supplies', 'Miscellaneous Business Equipment'] }
]

const COMMON_OPTION_TYPES = ['Color', 'Size', 'Material', 'Capacity', 'Pack Size', 'Paper Size']
...
export default function OfficeProductBuilder({ productType }: { productType: string | null }) {
  ...
  const [state, formAction, isPending] = useActionState(createOfficeProductAction, null)
  ...
  const { isRestoring, clearDraft } = useDraftAutoSave('office', draftState, (data) => {
  ...
  const activeCategory = OFFICE_CATEGORIES.find(c => c.id === category)

  const renderDynamicSpecs = () => {
    const lowerSub = subCategory.toLowerCase()
    
    if (lowerSub.includes('pen') || lowerSub.includes('marker') || lowerSub.includes('pencil') || lowerSub.includes('highlighter')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Ink Color / Lead Type</label><input type="text" value={attributes.Color || ''} onChange={e => handleAttributeChange('Color', e.target.value)} placeholder="e.g. Blue, Black, HB, 2B" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Tip Size / Point</label><input type="text" value={attributes.Size || ''} onChange={e => handleAttributeChange('Size', e.target.value)} placeholder="e.g. 0.5mm, 0.7mm, Fine Point" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Pack Size (Count)</label><input type="text" value={attributes.Count || ''} onChange={e => handleAttributeChange('Count', e.target.value)} placeholder="e.g. Box of 12, Pack of 5" className="w-full border rounded-md px-3 py-2" /></div>
    ...
    if (lowerSub.includes('notebook') || lowerSub.includes('paper') || lowerSub.includes('pad') || lowerSub.includes('journal')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Paper Size</label>
            <select value={attributes.PaperSize || ''} onChange={e => handleAttributeChange('PaperSize', e.target.value)} className="w-full border rounded-md px-3 py-2 bg-white">
          ...
          <div><label className="block text-sm font-medium mb-1">Page Count / Sheets</label><input type="text" value={attributes.Count || ''} onChange={e => handleAttributeChange('Count', e.target.value)} placeholder="e.g. 100 Pages, 500 Sheets (1 Ream)" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Paper Weight (GSM) / Ruling</label><input type="text" value={attributes.Weight || ''} onChange={e => handleAttributeChange('Weight', e.target.value)} placeholder="e.g. 80gsm, College Ruled, Blank" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Brand</label><input type="text" value={attributes.Brand || ''} onChange={e => handleAttributeChange('Brand', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
        </div>
      )
    }

    if (lowerSub.includes('printer') || lowerSub.includes('scanner') || lowerSub.includes('projector') || lowerSub.includes('shredder') || lowerSub.includes('machine') || lowerSub.includes('electronic') || lowerSub.includes('computer') || lowerSub.includes('laptop')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Specification / Type</label><input type="text" value={attributes.Spec || ''} onChange={e => handleAttributeChange('Spec', e.target.value)} placeholder="e.g. Laser, Inkjet, 1080p, Core i5" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Connectivity / Features</label><input type="text" value={attributes.Connectivity || ''} onChange={e => handleAttributeChange('Connectivity', e.target.value)} placeholder="e.g. Wi-Fi, USB, Bluetooth" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Power Source / Voltage</label><input type="text" value={attributes.Power || ''} onChange={e => handleAttributeChange('Power', e.target.value)} placeholder="e.g. 220V AC, Battery" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Brand</label><input type="text" value={attributes.Brand || ''} onChange={e => handleAttributeChange('Brand', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
        </div>
      )
    }

    if (lowerSub.includes('ink') || lowerSub.includes('toner') || lowerSub.includes('cartridge')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Compatible Printer Models</label><input type="text" value={attributes.Compatibility || ''} onChange={e => handleAttributeChange('Compatibility', e.target.value)} placeholder="e.g. HP LaserJet Pro M15w" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Color</label>
            <select value={attributes.Color || ''} onChange={e => handleAttributeChange('Color', e.target.value)} className="w-full border rounded-md px-3 py-2 bg-white">
              <option value="">Select...</option>
          ...
          <div><label className="block text-sm font-medium mb-1">Page Yield</label><input type="text" value={attributes.Yield || ''} onChange={e => handleAttributeChange('Yield', e.target.value)} placeholder="e.g. 1,000 Pages" className="w-full border rounded-md px-3 py-2" /></div>
          <div><label className="block text-sm font-medium mb-1">Brand</label><input type="text" value={attributes.Brand || ''} onChange={e => handleAttributeChange('Brand', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
        </div>
      )
    }

    if (lowerSub.includes('furniture') || lowerSub.includes('chair') || lowerSub.includes('desk') || lowerSub.includes('cabinet') || lowerSub.includes('shelf') || lowerSub.includes('safe')) {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div><label className="block text-sm font-medium mb-1">Material / Finish</label><input type="text" value={attributes.Material || ''} onChange={e => handleAttributeChange('Material', e.target.value)} placeholder="e.g. Wood, Steel, Mesh" className="w-full border rounded-md px-3 py-2" /></div>
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div><label className="block text-sm font-medium mb-1">Size / Capacity</label><input type="text" value={attributes.Size || ''} onChange={e => handleAttributeChange('Size', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
        <div><label className="block text-sm font-medium mb-1">Material / Pack Size</label><input type="text" value={attributes.Details || ''} onChange={e => handleAttributeChange('Details', e.target.value)} className="w-full border rounded-md px-3 py-2" /></div>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-4xl mx-auto pb-24">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-2xl font-bold tracking-tight">Add Office & Business Supplies</h1>
      </div>
